...
[assembly: FunctionsStartup(typeof(Challenge02.DataPollingFunction.Startup))]
namespace Challenge02.DataPollingFunction
{
    public class Startup : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddDbContext<DesafioContext>(opt => opt.UseSqlServer(configuration.GetValue<string>("SqlDatabaseConnection")));
